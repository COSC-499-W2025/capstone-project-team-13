...
|--------------|----------------------------------|-----------------|
| **Illina Islam** | Updated resume UI, updated documentation, implemented multiple resume features, implemented AI resume bullets, implemented resume export, made multiple updates to portfolio page (working on projects and skills + stats pages within portfolio, ensuring design aspects + functionality as the previous portfolio page was not very good), updated public mode for portfolio, API documentation, README documentation, Functional-reqs documentation, tech-stack documentation, use-cases documentation | 571, 550, 549, 538, 527, 488, 487, 485 |
| **Sana Shah** | Improved skills analysis efficiency, implemented private/public mode for portfolio, added thumbnails to portfolio page, updated system architecture diagram, made multiple updates to portfolio page, implemented public & private portfolio browsing, UI updates (settings, portfolio, skills), Bug report, script, team log documentation, updated our requirements | 555, 542, 541, 539, 528, 494 |
| **Maya Knutsvig** | made multiple updates to portfolio page (fixed entire layout, ensuring that the design was similar to designs you will see professionally), updated projects page, updated dashbaord customization, updates settings page, fixed AI token limit bug, project type routing, and evidence extraction, implemented AI interview prep feature, fixed light mode and dark mode inconsistencies, implemented avatar upload, implemented resume completeness scores, implemented dashboard onboarding, implemented search bar, README documentation, Installation guide | 544, 523, 522, 521, 520, 513, 514, 512, 511, 510, 509, 508, 493, 507 |
| **Prina Mehta** | Added 404 page, updated settings page, implemented dashboard columns, improves zip extraction, coding projects importance score, implemented portfolio showcase, impelmented skills timeline and heatmap, made many updates to frontend that were crucial to the project as previously the frontend was not cohesive (without this update, our frontend was not working and visually unappealing)  | 517, 518, 519, 489, 490 |
| **Jackson Wilson** | Updated navigation bar, added charts to dashboard, updated file type detection, implemented github usernames, fixed frontend bugs, implemented time estimation for project upload, dashboard walkthrough that takes the user through the entire project upon first entry so the user knows how to use the site, entire video demo | 495, 500, 505, 516, 537, 554, 572 |
